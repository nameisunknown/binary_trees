...
-   [Binary tree](https://en.wikipedia.org/wiki/Binary_tree "Binary tree")  (_note the first line:  `Not to be confused with B-tree.`_)
...
Write a function that checks if a binary tree is a valid  [Binary Search Tree](https://en.wikipedia.org/wiki/Binary_search_tree "Binary Search Tree")
...
Write a function that checks if a binary tree is a valid  [Max Binary Heap](https://en.wikipedia.org/wiki/Binary_heap "Max Binary Heap")
